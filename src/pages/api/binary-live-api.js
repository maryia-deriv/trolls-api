    ...
    return /******/ (function (modules) {
        ...
        /******/ [
                    ...
                    _createClass(LiveApi, [
                        ...
                        },
                        {
                            ...
                            value: function connect(connection) {
                                ...
                                try {
                                    this.socket = connection || ocket(urlPlusParams);
                                } catch (err) {
            ...
            /***/ function (module, exports) {
                ...
                var oauthUrlWithLanguage = (exports.oauthUrlWithLanguage = function oauthUrlWithLanguage(
                    appId,
                    langCode
                ) {
            ...
            /***/ function (module, exports) {
                ...
                var ServerError = (function (_Error) {
                    ...
                    function ServerError() {
                        var errorObj =
                            arguments.length <= 0 || arguments[0] === undefined ? { error: {} } : arguments[0];

                        _classCallCheck(this, ServerError);

                        var _this = _possibleConstructorReturn(
                            this,
                            Object.getPrototypeOf(ServerError).call(this, errorObj)
                        );
            ...
            /***/ function (module, exports) {
                ...
                var withdrawToPaymentAgent = (exports.withdrawToPaymentAgent = function withdrawToPaymentAgent(
                    options
                ) {
                    return _extends(
                        {
                ...
                var transferBetweenAccounts = (exports.transferBetweenAccounts = function transferBetweenAccounts(
                    options
                ) {
                    return _extends(
                        {
            ...
            /***/ function (module, exports) {
                ...
                var subscribeToOpenContract = (exports.subscribeToOpenContract = function subscribeToOpenContract(
                    contractId
                ) {
                    return {
                ...
                var unsubscribeFromAllOpenContracts = (exports.unsubscribeFromAllOpenContracts =
            ...
            /***/ function (module, exports) {
                ...
                var unsubscribeFromAlProposals = (exports.unsubscribeFromAlProposals =
                    function unsubscribeFromAlProposals() {
                        return {
                ...
                var getLandingCompanyDetails = (exports.getLandingCompanyDetails = function getLandingCompanyDetails(
                    landingCompany
                ) {
                    return {
                ...
                var subscribeToPriceForContractProposal = (exports.subscribeToPriceForContractProposal =
                ...
                var getCandlesForLastNDays = (exports.getCandlesForLastNDays = function getCandlesForLastNDays(
                    symbol,
                    ndays
                ) {
                    return {
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                function getDataForContract(api, getContract, durationCount) {
                        ...
                        return getContract().then(function (contract) {
                            ...
                            if (contractStart > (0, _nowAsEpoch2.default)()) {
                                return autoAdjustGetData(
                                    api,
                                    symbol,
                                    (0, _nowAsEpoch2.default)() - 600,
                                    (0, _nowAsEpoch2.default)(),
                                    style,
                                    subscribe
                                );
                            }
                    ...
                    return getContract().then(function (contract) {
                        ...
                        var start = Math.min(
                            startTime - buffer,
                            end - (0, _durationToSecs2.default)(durationCount, durationUnit)
                        );
